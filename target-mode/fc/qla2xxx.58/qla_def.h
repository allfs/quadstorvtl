...
#define MBC_TOGGLE_INTERRUPT		0x10	/* 82XX specific enable/disable
						 *  interrupts */
#define MBC_SET_LED_CONFIG		0x125	/* 82XX specific enable/disable
						 * beacon */
 ...
 */
#define MBX_WRITE_MPI_REGISTER		0x01	/* Write MPI Register. */
...
enum {
 	QS_NOTIFY_TYPE	= 0xffab1040,
 	QS_ATIO_TYPE	= 0xdd29a9b0,
};
