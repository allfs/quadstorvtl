...
static inline int
qla2x00_gid_list_size(scsi_qla_host_t *ha)
{
	return (sizeof(struct gid_list_info) * MAX_FIBRE_DEVICES_2400);
}
...
qla2x00_reset_active(scsi_qla_host_t *vha)
{
	...
	/* Test appropriate parent ha and ha flags */
	return test_bit(ISP_ABORT_NEEDED, &ha->dpc_flags) ||
