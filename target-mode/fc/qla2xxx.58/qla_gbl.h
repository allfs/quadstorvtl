...
extern int qla2x00_find_new_loop_id(scsi_qla_host_t *ha, fc_port_t *dev);
...
extern void *qla2x00_alloc_iocbs(scsi_qla_host_t *);
...
struct req_que;
extern void qla2x00_start_iocbs(struct scsi_qla_host *);
#endif /* _QLA_GBL_H */
